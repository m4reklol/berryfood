...
import { Heart, ArrowRight, ExternalLink, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
const CateringWeddings = () => {
  const { t } = useTranslation();
  const [isModalOpen, setIsModalOpen] = useState(false);
  
  // Gallery images (10 total, showing 8)
  const galleryImages: GalleryImage[] = [
    { src: '/svatbyintrogallery1.jpg', alt: 'Svatební catering 1' },
    { src: '/svatbyintrogallery2.jpg', alt: 'Svatební catering 2' },
    { src: '/svatbyintrogallery3.jpg', alt: 'Svatební catering 3' },
    { src: '/svatbyintrogallery4.jpg', alt: 'Svatební catering 4' },
    { src: '/svatbyintrogallery5.jpg', alt: 'Svatební catering 5' },
    { src: '/svatbyintrogallery6.jpg', alt: 'Svatební catering 6' },
    { src: '/svatbyintrogallery7.jpg', alt: 'Svatební catering 7' },
    { src: '/svatbyintrogallery8.jpg', alt: 'Svatební catering 8' },
    { src: '/svatbyintrogallery9.jpg', alt: 'Svatební catering 9' }
  ];
  ...
  const serviceFeatures = [
    {
      title: 'PROFESIONÁLNÍ OBSLUHA',
      description: '(doplnit 1-2 věty od klienta)'
    },
    {
  ...
  const breadcrumbItems = [
    ...
    { label: t('navigation.weddings'), current: true }
  ];

  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      <SEOHead pageKey="weddingCatering" />
      
      {/* Hero Section */}
      <SubpageHero
        title={t('pages.weddingCatering.hero.title')}
        subtitle={t('pages.weddingCatering.hero.subtitle')}
        imagePlaceholder="https://images.pexels.com/photos/1395967/pexels-photo-1395967.jpeg?auto=compress&cs=tinysrgb&w=1920"
        imagePlaceholder="/herosvatebnicatering.avif"
        ctaText={t('cta.requestWeddingCatering')}
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-lg border border-gray-100 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6 lg:space-y-8 text-lg lg:text-xl text-[var(--color-text)] leading-relaxed">
                <p className="font-semibold text-[var(--color-primary)] text-xl lg:text-2xl leading-relaxed border-l-4 border-[var(--color-accent)] pl-6 mb-8">
                  {t('pages.weddingCatering.intro.highlight')}
                </p>
                
                <p className="leading-loose">
                  {t('pages.weddingCatering.intro.text1')}
                </p>
                
                <p className="leading-loose">
                  {t('pages.weddingCatering.intro.text2')}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-[var(--color-primary)] mb-8 leading-tight">
              {t('pages.weddingCatering.sections.whyChooseUs')}
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              { title: t('pages.weddingCatering.features.completeService') },
              { title: t('pages.weddingCatering.features.individualApproach') },
              { title: t('pages.weddingCatering.features.professionalStaff') },
              { title: t('pages.weddingCatering.features.eleganceStyle') }
            ].map((feature, index) => (
              <div
                key={index}
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-white via-[#F8F5F0] to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-[var(--color-primary)] mb-8 leading-tight">
              {t('pages.weddingCatering.sections.whatToExpect')}
            </h2>
            <div className="flex justify-center">
              <div className="w-24 h-1 bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-sage)] rounded-full"></div>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#F8F5F0] via-white to-[#F5F1EB]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-[var(--color-primary)] mb-8 leading-tight">
              {t('pages.weddingCatering.sections.howWeWork')}
            </h2>
            <div className="flex justify-center">
              <div className="w-24 h-1 bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-sage)] rounded-full"></div>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-[var(--color-primary)] via-[#2A1F15] to-[var(--color-primary)] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-4 leading-tight">
            {t('pages.weddingCatering.sections.finalCta')}
          </h2>
          
          <p className="text-lg lg:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            {t('pages.weddingCatering.sections.finalCtaSubtitle')}
          </p>
          ...
          >
            ...
            <span className="relative z-10">{t('cta.requestWeddingCatering')}</span>
...
export default CateringWeddings;